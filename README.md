...
* **[Staid:](https://github.com/omcodedthis/Staid)** A Web App which complements a student's learning written in Python, HTML, CSS & JavaScript.

* **[EnvGPT:](https://github.com/omcodedthis/EnvGPT)** A text-based chatbot hosted on [Steamship](https://www.steamship.com/) that utilises [OpenAI's GPT-4](https://openai.com/gpt-4), providing an environmental viewpoint in its responses.
