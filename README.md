...
* **CS106A:** Introduces the fundamental concepts of programming and problem-solving using computing by Stanford University.
...
* **c-planner:** A program that automatically plans a duty schedule that is randomised for each person to prevent bias.
